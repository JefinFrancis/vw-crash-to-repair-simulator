...
class LatestCrashResponse(BaseModel):
    ...
    damaged_parts: Optional[List[Dict[str, Any]]] = Field(None, description="List of damaged parts with details")
    broken_parts: Optional[List[str]] = Field(None, description="List of broken part names")
    part_damage: Optional[Dict[str, float]] = Field(None, description="Damage level per part")
    damage_by_zone: Optional[Dict[str, float]] = Field(None, description="Damage by vehicle zone")
